...
CACHE_PREWARM_STARTUP_MONTHS = max(0, min(CACHE_PREWARM_MONTHS, int(os.environ.get("CACHE_PREWARM_STARTUP_MONTHS", "1"))))
CACHE_PREWARM_STARTUP_LIST_DATES = int(os.environ.get("CACHE_PREWARM_STARTUP_LIST_DATES", "1"))
CACHE_PREWARM_STARTUP_CHART_DATES = int(os.environ.get("CACHE_PREWARM_STARTUP_CHART_DATES", "0"))
